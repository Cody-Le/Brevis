...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if self.path != '/':
            ...
            output += '<h2 style= "text-align: center;">Query: {},  summarize to {}%</h2><br><h2>Summary</h2><br><img src={}><div style="padding: 0px 200px 20px 200px;">'.format(query, results['percentage'], img.getImg())
